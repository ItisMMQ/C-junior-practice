...
void printSet(const set<int>& s, const char *c) {
	cout << c << ": ";
...
void printMSet(const multiset<int>& s, const char *c) {
	cout << c << ": ";
...
int set_test() {
	...
	cout << "st2: ";
	copy(st2.begin(), st2.end(), out);// st2 = (8 7 6)
	cout << endl;
	...
	cout << "mst2: "; copy(mst2.begin(), mst2.end(), out); cout << endl; // mst2 = (8 7 6)
	...
	set<Person> pSet1(p, p + 5);                  //°´ÐÕÃûÅÅÐò
	set<Person, lesserAge> pSet2(p, p + 5);//°´ÄêÁäÅÅÐò
	cout << "pSet1: ";
	copy(pSet1.begin(), pSet1.end(), out2); // ** pSet1 = ((Ann,30) (Bill,20) (Gregg,25) (Kay,30)) **
	cout << endl;
	cout << "pSet2: ";
	copy(pSet2.begin(), pSet2.end(), out2); // ** pSet2 = ((Bill,20) (Gregg,25) (Ann,30) (Gregg,35)) **
	cout << endl;
	...
	cout << endl;
	cout << "pSet3: ";
	copy(pSet3.begin(), pSet3.end(), out2);
	cout << endl;// pSet3 = ((Ann,30) (Bill,20) (Gregg,25) (Gregg,35) (Kay,30))
	cout << "pSet4: "; copy(pSet4.begin(), pSet4.end(), out2);
	cout << endl;// pSet4 = ((Bill,20) (Gregg,25) (Ann,30) (Kay,30) (Gregg,35))
